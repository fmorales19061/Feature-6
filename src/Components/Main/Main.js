...
import GpuList from "../Services/GpuList";
...
function Main() {
  ...
  return (
    <div>
      ...
      Ever wanted to sell your soul to our corporate overlords? Fear no more as
      you can do just that in order to get the latest and fastest GPU!
      <GpuList gpus={gpus} />
